...
#define OV_VOLTAGE_THRESHOLD_V          446 /*!< Over-voltage
                                                         threshold */
...
#define PHASE1_FINAL_CURRENT           5957
/* Phase 2 */
#define PHASE2_DURATION                5000 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (1800*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           8936
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (1800*SPEED_UNIT/_RPM)
